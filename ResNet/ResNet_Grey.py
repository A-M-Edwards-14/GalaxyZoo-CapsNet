...
transformed_train2 = transformed_train.reshape(50170, 1, 72, 72) 
transformed_trainTwo = transformed_train_2.reshape(50170, 1, 72, 72) 
transformed_trainThree = transformed_train_3.reshape(50170, 1, 72, 72)
transformed_test2 = transformed_test.reshape(11408, 1, 72, 72)
transformed_Normalized2 = transformed_Normalized.reshape(50170, 1, 72, 72)
...
np.save('../ResNet/results/train_history_Grey.npy', train_history)
np.save('../ResNet/results/test_history_Grey.npy', eval_history)
torch.save(net.state_dict(), '../ResNet/results/epoch_Grey.pt')
